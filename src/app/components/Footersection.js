        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>📞 0923798109 (จ.-ศ. 09:00 - 18:00)</li>
              <li>✉️ champ35099@gmail.com</li>
            </ul>
           
            {/* ปุ่ม Social Media แบบจำลอง (ใส่ลิงก์จริงที่ href) */}
            <div className="mt-4 flex space-x-4">
              <a href="https://web.facebook.com/phu.dis.th.ni.pha.ph.rn" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors">
              ...
              <a href="https://www.instagram.com/champmlkhiop/" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-600 transition-colors">
